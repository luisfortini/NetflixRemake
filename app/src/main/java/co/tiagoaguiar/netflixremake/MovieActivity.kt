...
class MovieActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtDesc.text =
            "Essa é a descrição deste filme incrível que foi produzido com os melhores atores. "
        txtCast.text = getString(
            R.string.cast,
            "Luis Fortini, Felipe Henrique, Vitor Augusto, Arlindo Junior, David Gustavo"
        )
